...
const pswd = "Harman.2025"

const kg = 160
const M3 = 0.8414

const bd1 = "SELECT * FROM bd1";
const inserbd1 = "INSERT INTO bd1 (inH2O,Promedio,DATE) VALUES (?,?,?)";
...
async function OpenPage() {
    try {
        ...
        connection.query(inserbd1, [r1, Promedio, fecha1], (err, results) => {
            if (err) {
    ...
    await browser.close()
        ...
        console.error("Error in OpenPage function:", error);
        setTimeout(() => {
            OpenPage();
        }, 10000);
    }
